...
bash scripts/test_dist_all.sh logs/netVLAD/robotcar-vgg16/conv5-triplet-lr0.001-neg10-tuple2/model_best.pth.tar /home/lab/data1/hanjing 512 conv5 vgg16