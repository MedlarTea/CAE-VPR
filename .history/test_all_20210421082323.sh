...
bash scripts/test_dist_all.sh logs/netVLAD/attention/student/robotcar30k-vgg16/conv5-conv6-vistypepow2-vprLtriplet-attLmse-lvpr1.0-latt1.0-lr0.001-neg10-tuple2/checkpoint20.pth.tar /home/lab/data1/hanjing 512 conv5 vgg16
