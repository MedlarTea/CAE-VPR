...
def get_data(args, iters):
    ...
    return dataset, train_loader, val_loader, test_loader, sampler, train_extract_loader, val_loader_qs, val_loader_dbs
...
def main_worker(args):
    ...
    dataset, train_loader, val_loader, test_loader, sampler, train_extract_loader, val_loader_qs, val_loader_dbs = get_data(args, iters)
