...
def drawL2Distribution(root_dir, method, dataset):
    ...
    plt.hist(bins_y[:-1], bins_y, weights=counts_y/len(falseMatches), color="yellow", edgecolor = 'black', alpha=0.5, label="False matches(u={:.3f}, var={:.3f})".format(false_mean, false_std))
