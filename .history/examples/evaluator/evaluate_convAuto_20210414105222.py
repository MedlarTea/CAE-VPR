...
def drawCosDistanceDistributionCore(root_dir, method, dataset):
    ...
    plt.savefig("./results/{}_{}_cosDistDistri.png".format(dataset, method),dpi=600)
    plt.close()

def drawCosDistanceDistribution():
    # for robotcar(dbNight vs. qSnow)
    dataset = "robotcar(dbNight vs. qSnow)"
    method = "oursV(4096d)"
    drawCosDistanceDistributionCore(rootDirs[method], method, dataset)
    method = "Vgg16"
    drawCosDistanceDistributionCore(rootDirs[method], method, dataset)
    method = "Netvlad"
    drawCosDistanceDistributionCore(rootDirs[method], method, dataset)
