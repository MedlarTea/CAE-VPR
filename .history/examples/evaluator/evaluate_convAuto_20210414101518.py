...
def drawL2Distribution(root_dir, method, dataset):
    ...
    plt.hist(bins_y[:-1], bins_y, weights=counts_y/len(falseMatches)*100, color="deepskyblue", alpha=0.8, label="False matches(u={:.3f}, var={:.3f})".format(false_mean, false_std))
