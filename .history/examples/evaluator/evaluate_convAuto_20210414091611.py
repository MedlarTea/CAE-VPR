...
def drawL2Distribution(root_dir, method, dataset):
    ...
    plt.hist(bins_x[:-1], bins_x, density=True, color="darkorange", edgecolor = 'black', alpha=0.5, label="True matches(u={:.3f}, var={:.3f})".format(true_mean, true_std))
    ...
    plt.hist(bins_y[:-1], bins_y, density=True, color="darkcyan", edgecolor = 'black', alpha=0.5, label="False matches(u={:.3f}, var={:.3f})".format(false_mean, false_std))
