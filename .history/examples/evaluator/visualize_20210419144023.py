...
def testRemoveDynamic():
    ...
    # query
    query_path = "/home/lab/data1/hanjing/singleframe/Kudamm_RAS2020/Live/image0025.jpg"
    query_semantic_path = "/home/lab/data1/hanjing/singleframe/Kudamm_RAS2020/Live_semantics/image0025.jpg"
    img = get_image(query_path)
    img_no_dynamic = remove_dynamic(query_semantic_path, img)
    with torch.no_grad():
        _, query_masked_desc = model(img_no_dynamic.unsqueeze(0))
