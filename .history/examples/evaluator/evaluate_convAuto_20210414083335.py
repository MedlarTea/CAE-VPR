...
def drawL2Distribution(method, dataset, trueMatches, falseMatches):
    ...
    plt.figure()
    counts_x, bins_x = np.histogram(trueMatches,bins=40)
    ...
    counts_y, bins_y = np.histogram(falseMatches,bins=40)
...
if __name__ == '__main__':
    ...
    trueMatches = osp.join(root_dir, "robotcar_qSnow_dbNight_distri_trueMatches.npy")
    falseMatches = osp.join(root_dir, "robotcar_qSnow_dbNight_distri_falseMatches.npy")
