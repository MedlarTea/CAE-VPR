...
def get_data(args):
    ...
    allDatasets["robotcar_qAutumn_dbSunCloud"] = datasets.create("robotcar", root, datelist=osp.join(root, 'datelist.txt'), q_date='2014-12-09-13-21-02', db_val_date='2014-12-16-18-44-24', db_test_date='2014-11-18-13-20-12')
    allDatasets["robotcar_qAutumn_dbNight"] = datasets.create("robotcar", root, datelist=osp.join(root, 'datelist.txt'), q_date='2014-12-09-13-21-02', db_val_date='2014-11-18-13-20-12', db_test_date='2014-12-16-18-44-24')
    allDatasets["robotcar_qSnow_dbNight"] = datasets.create("robotcar", root, datelist=osp.join(root, 'datelist.txt'), q_date='2015-02-03-08-45-10', db_val_date='2014-11-18-13-20-12', db_test_date='2014-12-16-18-44-24')
    allDatasets["robotcar_qSnow_dbSunCloud"] = datasets.create("robotcar", root, datelist=osp.join(root, 'datelist.txt'), q_date='2015-02-03-08-45-10', db_val_date='2014-12-16-18-44-24', db_test_date='2014-11-18-13-20-12')
