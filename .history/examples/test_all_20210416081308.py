...
def get_data(args):
    ...
    robotcar = datasets.create("robotcar", root, datelist=osp.join(root, 'datelist_PR_Attention.txt'), q_date='2015-02-03-08-45-10', db_val_date='2015-11-10-14-15-57', db_test_date='2015-07-10-10-01-59')
    pitts_train = sorted(list(set(robotcar.q_train) | set(robotcar.db_train)))
    train_extract_loader = DataLoader(
        Preprocessor(pitts_train, root=robotcar.images_dir, transform=test_transformer_db),
