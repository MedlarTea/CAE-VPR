...
def get_data(args, iters):
    ...
    if dataset == "pitts":
        ...
        dataset = datasets.create("robotcar", root, datelist=osp.join(root, 'datelist_PR_Attention.txt'), q_date='2015-02-03-08-45-10', db_val_date='2014-12-10-18-10-50', db_test_date='2014-12-16-18-44-24')
