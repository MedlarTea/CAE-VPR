    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if ((epoch+1)%args.eval_step==0 or (epoch==args.epochs-1)):
            ...
            for name in val_datasets.keys():
                ...
                s_auc, s_recalls = evaluator.evaluate(test_loader_qs[name], sorted(list(set(val_datasets[name].q_test) | set(val_datasets[name].db_test))),
                            val_datasets[name].q_test, val_datasets[name].db_test, val_datasets[name].test_pos, gallery_loader=test_loader_dbs[name],
