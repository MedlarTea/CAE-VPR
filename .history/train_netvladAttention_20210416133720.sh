...
bash scripts/train_attention_student.sh triplet mse /home/lab/data1/hanjingModel/OpenIBL/logs/netVLAD/attention/pitts30k-vgg16/conv5-vprlosstriplet-lr0.001-neg10-tuple4/model_best.pth.tar 1.0 1.0
