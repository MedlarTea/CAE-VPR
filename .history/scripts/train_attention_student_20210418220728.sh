...
--logs-dir logs/netVLAD/attention/student_NoTeacher/${DATASET}${SCALE}-${ARCH}/${LAYERS}-${RETURNLAYER}-vistype${VISTYPE}-vprL${VPRLOSS}-attL${ATTLOSS}-lvpr${LVPR}-latt${LATT}-lr${LR}-neg${NEGNUM}-tuple$[${TUPLESIZE}*${GPUS}] \
--data-dir ${DATRDIR}
