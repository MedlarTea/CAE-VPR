...
bash scripts/train_attention_student.sh triplet mse logs/netVLAD/attention/teacher/robotcar-vgg16/conv5-triplet-lr0.001-neg10-tuple2/model_best.pth.tar 1.0 10.0
