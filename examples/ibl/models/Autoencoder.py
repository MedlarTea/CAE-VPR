...
#         super(convAuto, self).__init__()
#         self.encoder = nn.Sequential(
#             nn.Conv2d(512, d1, (3,3), stride=(1,1), padding=0),
#             nn.BatchNorm2d(d1),
#             nn.PReLU(),

#             nn.Conv2d(d1, d2, (3,3), stride=(1,1), padding=0), 
#             nn.BatchNorm2d(d2),
#             nn.PReLU(),

#             nn.Conv2d(d2, dimension, (3,3), stride=(1,1), padding=0),   # dimension x 4 x 8
#             nn.BatchNorm2d(dimension),
#             nn.PReLU(),
#         )

#         self.decoder = nn.Sequential(
#             nn.ConvTranspose2d(dimension, d2, (3,3), stride=(1,1), padding=0), 
#             nn.BatchNorm2d(d2),
#             nn.PReLU(),

#             nn.ConvTranspose2d(d2, d1, (3,3), stride=(1,1), padding=0), 
#             nn.BatchNorm2d(d1),
#             nn.PReLU(),

#             nn.ConvTranspose2d(d1, 512, (3,3), stride=(1,1), padding=0), 
#             nn.BatchNorm2d(512),
#             nn.PReLU()
#             # nn.Tanh()
#         )
...
class convAutoAlextnet(nn.Module):
    def __init__(self, d1, d2, dimension):
        ...
        # original d1=512, d2=1024
        self.encoder = nn.Sequential(
            nn.Conv2d(256, d1, (4,4), stride=(1,1), padding=0),
            nn.BatchNorm2d(d1),
            nn.PReLU(),

            nn.Conv2d(d1, d2, (5,3), stride=(2,2), padding=0),
            nn.BatchNorm2d(d2),
            nn.PReLU(),
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose2d(d2, d1, (5,3), stride=(2,2), padding=0),
            nn.BatchNorm2d(d1),
            nn.PReLU(),

            nn.ConvTranspose2d(d1, 256, (4,4), stride=(1,1), padding=0),
            nn.BatchNorm2d(256),
            nn.PReLU()
            # nn.Tanh()
        )
...
#         # original d1=512, d2=1024
#         self.encoder = nn.Sequential(
#             nn.Conv2d(256, d1, (3,3), stride=(1,1), padding=0),
#             nn.BatchNorm2d(d1),
#             nn.PReLU(),
...
#             nn.ConvTranspose2d(d1, 256, (3,3), stride=(1,1), padding=0),
#             nn.BatchNorm2d(256),
#             nn.PReLU()
#             # nn.Tanh()
#         )
