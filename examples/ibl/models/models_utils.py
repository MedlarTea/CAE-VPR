...
class create_conv_1(nn.Module):

    def __init__(self, c1, c2):
        super(create_conv_1, self).__init__()
...
class create_conv_3_in_noReLU(nn.Module):

    def __init__(self, c1, c2, track=True):
        super(create_conv_3_in_noReLU, self).__init__()
        self.conv = nn.Sequential(nn.Conv2d(c1, c2, 3, 1, 1),
                                  nn.BatchNorm2d(c2),
                                  nn.ReLU(),
                                  nn.Conv2d(c2, c2, 3, 1, 1),
...
class create_deconv_2_in_noReLU(nn.Module):

    def __init__(self, c1, c2, track=True):
        super(create_deconv_2_in_noReLU, self).__init__()
        self.conv = nn.Sequential(nn.ConvTranspose2d(c1, c2, 3, 1, 1),
                                  nn.BatchNorm2d(c2),
                                  nn.ReLU(),
                                  nn.ConvTranspose2d(c2, c2, 3, 1, 1),)
